...
export const AdvantagesSection: React.FC = () =>{
    const [data, setData] = useState<AdavantageData[]>([]);
    ...
    return(
        <AdvantagesSectionContainer id="Advantages">
            ...
            <AdvantagesCardContainer>
                ...
                title={data[0].title} description={"With our smart, innovative and disruptive technology we are able to mine gold sustainably"}/>
